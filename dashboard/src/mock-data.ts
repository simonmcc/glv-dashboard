...
const apiDaysFromNow = (days: number) =>
  apiDate(new Date(today.getTime() + days * 24 * 60 * 60 * 1000));
...
export const mockAppointmentRecords: AppointmentRecord[] = [
  ...
  },
  {
    ...
    "Last name": "Wilson",
    "Membership number": "78901234",
    Role: "Explorer Scout Leader",
    Team: "Explorers",
    "Unit name": "1st Demo Group",
    "Start date": daysAgo(250),
  },
  {
    "First name": "Ian",
    "Last name": "Clarke",
    "Membership number": "90123456",
    Role: "Chair",
    Team: "",
    "Unit name": "1st Demo Group",
    "Start date": daysAgo(700),
  },
  {
    "First name": "Judith",
    "Last name": "Adams",
    "Membership number": "01234567",
    Role: "Trustee",
    Team: "",
    "Unit name": "1st Demo Group",
    "Start date": daysAgo(200),
  },
];
...
export const mockMemberLearningResults: MemberLearningResult[] = [
    ...
    modules: [
      {
        ...
        expiryDate: apiDaysFromNow(365),
        currentLevel: "Achieved skill",
      },
      {
        title: "Safety",
        expiryDate: apiDaysFromNow(180),
        currentLevel: "Achieved skill",
      },
      {
        title: "Safeguarding",
        expiryDate: apiDaysFromNow(200),
        currentLevel: "Achieved skill",
      },
      {
        title: "GDPR",
        expiryDate: apiDaysFromNow(300),
        currentLevel: "Achieved skill",
      },
    ],
  },
  {
    ...
    modules: [
      {
        title: "First Response",
        expiryDate: apiDaysFromNow(25),
        currentLevel: "Achieved skill",
      }, // Expiring
      {
        title: "Safety",
        expiryDate: apiDaysFromNow(30),
        currentLevel: "Achieved skill",
      },
      {
        title: "Safeguarding",
        expiryDate: apiDaysFromNow(150),
        currentLevel: "Achieved skill",
      },
    ],
  },
  {
    ...
    modules: [
      ...
      {
        title: "Safety",
        expiryDate: apiDaysAgo(15),
        currentLevel: "Achieved skill",
      }, // Expired
      {
        title: "Safeguarding",
        expiryDate: apiDaysFromNow(45),
        currentLevel: "Achieved skill",
      },
    ],
  },
